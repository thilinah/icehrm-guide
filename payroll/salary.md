...
In icehrm we have employee salary components \(e.g Car Allowance\) which are grouped into salary component types \(e.g Allowances\). Then for each employee you can add actual numbers for each of the salary component.
