...
As this column only depends on Basic Salary component you can just select the that salary component from the list. \(Note that in some cases you can add multiple salary components to same column\).
